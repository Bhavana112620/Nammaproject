...
public class Hooks {
    ...
    public void tearDown(Scenario scenario) throws IOException {
        if (scenario.isFailed()) {
            // Take screenshot
            TakesScreenshot ts = (TakesScreenshot) Step1.driver;
            ...
            File targetFile = new File("C:\\Users\\jeeva\\Documents\\workspace-spring-tools-for-eclipse-4.32.2.RELEASE\\TutorialNinjaAutomationProject\\screenshots\\bug2.png");
